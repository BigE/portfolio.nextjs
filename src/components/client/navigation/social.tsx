...
export default function SocialNavigation( { items, ...props }: SocialNavigationProps & JSX.IntrinsicElements["nav"]) {
	...
	for (const item of items) {
		...
		children.push(<li key={item.sys.id} className="pure-menu-item">
			<a href={item.fields.url} className={`pure-menu-link link ${styles.link}`} title={item.fields.url}>
